...
class PandaRobotGymEnv(gym.Env):
    ...
    def step(self, action):
        ...
        z = hand_pos[2] - self.goal[2] #Differenz in z-Richtung
        goal_dist = np.linalg.norm(self.goal - hand_pos) #Entfernung Endeffektor zum Ziel
        vector_dist = self.goal - hand_pos #Differenz in x,y,z,-Richtung
        obs = self.joint_state
        obs = np.append(obs, vector_dist)
        ...
        if self.joint1 < self.joint1_threshold_min or self.joint1 > self.joint1_threshold_max \
            ...
            self.done = True
            reward = -50 #Strafe für Gelenküberschreitung
            ...
            if self._env_step_counter >= self._max_steps:
                ...
                #Abbruch falls Endeffektor nah genug am Ziel
                reward = 0
                #print("Action: ", action)
